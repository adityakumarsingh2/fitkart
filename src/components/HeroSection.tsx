          ...
          <div className="relative animate-fade-up" style={{ animationDelay: "0.2s" }}>
            <div className="relative aspect-[4/5] max-w-md mx-auto">
              ...
              <div className="absolute inset-0 bg-card rounded-3xl shadow-elegant overflow-hidden">
                ...
                <img src="https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=800&auto=format&fit=crop" alt="Fashion model showcasing virtual try-on" className="w-full h-full object-cover"/>
